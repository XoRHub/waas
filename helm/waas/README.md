...
| secretsJob.image | string | `"bitnami/kubectl:latest@sha256:1a86ba502f618724fd493f6a2b129f060454db04f06faa58d8ed94510280b17f"` | Image used by the secrets-generation hook Job. |
...
| jwtJob.image | string | `"bitnami/kubectl:latest@sha256:1a86ba502f618724fd493f6a2b129f060454db04f06faa58d8ed94510280b17f"` | Image used by the JWT signing-key hook Job (kubectl + openssl, same as secretsJob's). |
...
| postgres.image | string | `"postgres:18.6-alpine@sha256:d3e1620b530c944afa6e887d22eb899824da68e19c52024bf98f5220c88a65b2"` | postgres image reference; only used when postgres.enabled is true. |
