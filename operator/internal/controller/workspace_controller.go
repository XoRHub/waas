...
// This file owns the Reconcile loop and its setup only. Do NOT add new
// responsibilities here: they live in a dedicated satellite file named
// by responsibility (workload.go, placement.go, workspace_status.go, …).
